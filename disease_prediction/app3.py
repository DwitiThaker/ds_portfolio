...
# Load the appropriate models based on dataset selected
diabetes_logistic_model = pickle.load(open(f'{working_dir}/saved_models/logistic_regression.pkl', 'rb'))
diabetes_rf_model = pickle.load(open(f'{working_dir}/saved_models/random_forest.pkl', 'rb'))
diabetes_svm_model = pickle.load(open(f'{working_dir}/saved_models/svm.pkl', 'rb'))

heart_logistic_model = pickle.load(open(f'{working_dir}/saved_models/logistic_regression1.pkl', 'rb'))
heart_rf_model = pickle.load(open(f'{working_dir}/saved_models/random_forest1.pkl', 'rb'))
heart_svm_model = pickle.load(open(f'{working_dir}/saved_models/svm1.pkl', 'rb'))

parki = pickle.load(open(f'{working_dir}/saved_models/Parkinson_disease.pkl', 'rb'))
...
# Define model selection and prediction logic
def select_model(dataset_choice, model_choice):
    if dataset_choice == 'Diabetes Prediction':
        if model_choice == "Logistic Regression":
            return diabetes_logistic_model
        elif model_choice == "Random Forest":
            return diabetes_rf_model
        elif model_choice == "SVM":
            return diabetes_svm_model
    elif dataset_choice == 'Heart Disease Prediction':
        if model_choice == "Logistic Regression":
            return heart_logistic_model
        elif model_choice == "Random Forest":
            return heart_rf_model
        elif model_choice == "SVM":
            return heart_svm_model
    elif dataset_choice == 'Parkinsons Disease Prediction':
        if model_choice == "Logistic Regression":
            return heart_logistic_model
        elif model_choice == "Random Forest":
            return heart_rf_model
...
if selected == 'Diabetes Prediction':
    ...
    # Model selection for Diabetes Prediction
    ...
    if st.button('Diabetes Test Result'):
        ...
        selected_model = select_model('Diabetes Prediction', model_choice)
        diab_prediction = selected_model.predict([user_input])
...
if selected == 'Heart Disease Prediction':
    ...
    if st.button('Heart Disease Test Result'):
        ...
        selected_model = select_model('Heart Disease Prediction', model_choice)
        heart_prediction = selected_model.predict([user_input])
...
if selected == "Parkinson Disease Prediction":
    ...
    if st.button("Parkinson's Test Result"):
        ...
        parkinsons_prediction = parki.predict([user_input])
